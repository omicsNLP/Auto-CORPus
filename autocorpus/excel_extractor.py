"""This module provides functionality for extracting and converting Excel tables into BioC format.

It includes:
- BioCTable: A class to represent tables in BioC format.
- Utility functions for processing text and DataFrame objects.
"""
