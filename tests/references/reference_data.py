...
example_pmc_correct_reference = {
    "body": "References1.Sheikhalishahi S, Miotto R, Dudley JT, Lavelli A, "
    "Rinaldi F, Osmani V. Natural language processing of clinical notes "
    "on chronic diseases: systematic review. JMIR Med Inform. (2019) "
    "7:e12239. 10.2196/12239 [DOI] [PMC free article] [PubMed] [Google "
    "Scholar]2.Jackson RG, Patel R, Jayatilleke N, Kolliakou A, Ball M, "
    "Gorrell G, et al. Natural language processing to extract symptoms of "
    "severe mental illness from clinical text: the Clinical Record "
    "Interactive Search Comprehensive Data Extraction (CRIS-CODE) "
    "project. BMJ Open. (2017) 7:e012012. 10.1136/bmjopen-2016-012012 "
    "[DOI] [PMC free article] [PubMed] [Google Scholar]3.Erhardt RA, "
    "Schneider R, Blaschke C. Status of text-mining techniques applied to "
    "biomedical text. Drug Discov Today. (2006) 11:315–25. "
    "10.1016/j.drudis.2006.02.011 [DOI] [PubMed] [Google Scholar]4.Wang "
    "LL, Cachola I, Bragg J, Yu-Yen Cheng E, Haupt C, Latzke M, et al. "
    "Improving the accessibility of scientific documents: current state, "
    "user needs, and a system solution to enhance scientific PDF "
    "accessibility for blind and low vision users. arXiv e-prints: "
    "arXiv:2105.00076 (2021). Available online at: "
    "https://arxiv.org/pdf/2105.00076.pdf5.Comeau DC, Islamaj Dogan R, "
    "Ciccarese P, Cohen KB, Krallinger M, Leitner F, et al. BioC: a "
    "minimalist approach to interoperability for biomedical text "
    "processing. Database. (2013) 2013:bat064. 10.1093/database/bat064 "
    "[DOI] [PMC free article] [PubMed] [Google Scholar]6.Comeau DC, Wei "
    "CH, Islamaj Dogan R, Lu Z. PMC text mining subset in BioC: about "
    "three million full-text articles and growing. Bioinformatics. (2019) "
    "35:3533–5. 10.1093/bioinformatics/btz070 [DOI] [PMC free article] "
    "[PubMed] [Google Scholar]7.Ceusters W. An information artifact "
    "ontology perspective on data collections and associated "
    "representational artifacts. Stud Health Technol Inform. (2012) "
    "180:68–72. 10.3233/978-1-61499-101-4-68 [DOI] [PubMed] [Google "
    "Scholar]8.Milosevic N, Gregson C, Hernandez R, Nenadic G. "
    "Disentangling the structure of tables in scientific literature. In: "
    "Métais E, Meziane F, Saraee M, Sugumaran V, Vadera S, editors. "
    "Natural Language Processing and Information Systems. Cham: Springer "
    "International Publishing; (2016). p. 162–74. "
    "10.1007/978-3-319-41754-7_14 [DOI] [Google Scholar]9.Craven M, "
    "Kumlien J. Constructing biological knowledge bases by extracting "
    "information from text sources. In: International Conference on "
    "Intelligent Systems for Molecular Biology.Heidelberg: (1999) p. "
    "77–86. [PubMed] [Google Scholar]10.Blaschke C, Andrade MA, Ouzounis "
    "C, Valencia A. Automatic extraction of biological information from "
    "scientific text: protein-protein interactions. In: International "
    "Conference on Intelligent Systems for Molecular Biology. Heidelberg: "
    "(1999) p. 60–7. [PubMed] [Google Scholar]11.Andrade MA, Valencia A. "
    "Automatic annotation for biological sequences by extraction of "
    "keywords from MEDLINE abstracts. Development of a prototype system. "
    "Proc Int Conf Intell Syst Mol Biol. (1997) 5:25–32. [PubMed] [Google "
    "Scholar]12.Schwartz AS, Hearst MA. A simple algorithm for "
    "identifying abbreviation definitions in biomedical text. Pac Symp "
    "Biocomput. (2003) 8:451–62. Available online at: "
    "https://psb.stanford.edu/psb-online/proceedings/psb03/schwartz.pdf "
    "[PubMed] [Google Scholar]13.Beck T, Shorter T, Brookes AJ. GWAS "
    "Central: a comprehensive resource for the discovery and comparison "
    "of genotype and phenotype data from genome-wide association studies. "
    "Nucleic Acids Res. (2020) 48:D933–40. 10.1093/nar/gkz895 [DOI] [PMC "
    "free article] [PubMed] [Google Scholar]14.Ghazvinian A, Noy NF, "
    "Musen MA. Creating mappings for ontologies in biomedicine: simple "
    "methods work. AMIA Annu Symp Proc. (2009) 2009:198–202. [PMC free "
    "article] [PubMed] [Google Scholar]15.Keller MF, Reiner AP, Okada Y, "
    "van Rooij FJ, Johnson AD, Chen MH, et al. Trans-ethnic meta-analysis "
    "of white blood cell phenotypes. Hum Mol Genet. (2014) 23:6944–60. "
    "10.1093/hmg/ddu401 [DOI] [PMC free article] [PubMed] [Google "
    "Scholar]16.Milosevic N, Gregson C, Hernandez R, Nenadic G. A "
    "framework for information extraction from tables in biomedical "
    "literature. Int J Docum Anal Recogn. (2019) 22:55–78. "
    "10.1007/s10032-019-00317-023869631 [DOI] [Google Scholar]17.Islamaj "
    "R, Kwon D, Kim S, Lu Z. TeamTat: a collaborative text annotation "
    "tool. Nucleic Acids Res. (2020) 48:W5–11. 10.1093/nar/gkaa333 [DOI] "
    "[PMC free article] [PubMed] [Google Scholar]",
    "section_heading": "References",
    "section_type": [{"iao_id": "IAO:0000320", "iao_name": "references section"}],
    "subsection_heading": "",
}
